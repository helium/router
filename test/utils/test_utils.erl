...
init_per_testcase(TestCase, Config) ->
    ...
    ok = application:set_env(router, router_metrics_reporter_prometheus_port, 4000),
...
frame_payload(MType, DevAddr, NwkSessionKey, AppSessionKey, FCnt, Options) ->
    ...
    Payload0 =
        <<MType:3, MHDRRFU:3, Major:2, DevAddr:4/binary, ADR:1, ADRACKReq:1, ACK:1, RFU:1,
            FOptsLen:4, FCnt:16/little-unsigned-integer, FOptsBin:FOptsLen/binary, Port:8/integer,
            Data/binary>>,
