...
dc_test(Config) ->
    ...
    %% FIXME: I don't think this test is correct anymore.
    %% Sending the same packet, same frame, multi-buy:1, no queue
    %% We should _not_ be buying from 2 hotspots.
    %% Failure is complaining about dc.balance
    %% and reported hotspots.
